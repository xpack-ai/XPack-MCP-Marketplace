...
class ResourceGroupService:
    ...
    def create_group(self, gid: str, name: str, description: Optional[str], is_default: bool = False) -> str:
        with self.db.begin():
            ...
            print(f"Created resource group {gid}, name={name}, description={description}, is_default={is_default}")
            if is_default:
    ...
    def bind_services(self, gid: str, service_ids: List[str]) -> int:
        ...
        with self.db.begin():
            ...
            return self.map_repo.bind_services(gid, valid_ids, commit=False)
